...
def _data_generation(args):
    if args.type == "sat":
        ...
        gen.generate(gen_labels=args.gen_labels, weighted=args.weighted, label_solver=args.label_solver)
...
if __name__ == "__main__":
    ...
    data_gen_parser.add_argument("--sub_opt", action="store_true", help="generate suboptimal labels")
    data_gen_parser.add_argument("--label_solver", type=str, default="kamis", help="Specify the solver to use for generating labels", choices=["gurobi", "kamis", "both"])
